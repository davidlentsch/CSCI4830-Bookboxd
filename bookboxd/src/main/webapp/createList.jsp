	...
	<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
		<header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
			<div class="mdl-layout__header-row">
				<span class="mdl-layout-title">Add New List</span>
		...
		<div class="mdl-grid demo-content">
			<div class="edit-profile mdl-color--white mdl-shadow--2dp mdl-cell--5-col" style="padding: 16px;">
				<form action="Lists" method="get">
					<input type="hidden" id="action" name="action" value="addList">
					<div class="mdl-textfield mdl-js-textfield">
						<input class="mdl-textfield__input" type="text" id="list_name" name="list_name">
					...
					<div>
						...
						&nbsp;&nbsp;
						<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" type="submit">Add List</button>
					</div>
				</form>
			</div>
		</div>
