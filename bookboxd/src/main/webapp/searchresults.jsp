            ...
            <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
                ...
                <div class="android-content mdl-layout__content">
                    ...
                    <div class="android-more-section">
                        <div class="android-section-title mdl-typography--display-1-color-contrast">Search results for "${query}"</div>
                        <div class="android-card-container mdl-grid">
                            <c:forEach items="${searchresults}" var="item">
                                ...
                                <div
                                    ...
                                    <div class="mdl-card__supporting-text">
                                        <span
                                            class="mdl-typography--font-light mdl-typography--subhead">${item.description}</span>
                                    </div>
                        ...
                        <div class="mdl-mega-footer--middle-section">
                            <p class="mdl-typography--font-light">
                                Web template based upon the <a
                                    ...
                                    Material Design Lite template</a>. Licensed under the <a href="LICENSE.txt">Apache
                                    2.0 license.</a>
                            </p>
                        </div>
