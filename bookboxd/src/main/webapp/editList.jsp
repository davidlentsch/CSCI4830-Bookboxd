...
<title>Bookboxd - Edit List</title>
	...
	<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
		<header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
			<div class="mdl-layout__header-row">
				<span class="mdl-layout-title">Edit List</span>
		...
		<div class="mdl-grid demo-content">
			<div class="edit-profile mdl-color--white mdl-shadow--2dp mdl-cell--5-col" style="padding: 16px;">
				<form action="Lists" method="get">
					<input type="hidden" id="action" name="action" value="editList">
					<input type="hidden" id="list_id" name="list_id" value="${list.list_id}">
					<div class="mdl-textfield mdl-js-textfield">
						<input class="mdl-textfield__input" type="text" id="list_name" name="list_name" value="${list.list_name}">
					    <label class="mdl-textfield__label" for="list_name">List Name</label>
					</div>
					<br><br>
					...
					<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="public">
						<c:choose>
							<c:when test="${list.privacy_setting == 0}">
								<input type="radio" id="public" class="mdl-radio__button" name="privacy_setting" value="0" checked>							
							</c:when>
							<c:otherwise>
								<input type="radio" id="public" class="mdl-radio__button" name="privacy_setting" value="0">
							</c:otherwise>
						</c:choose>
					...
					<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="private">
						<c:choose>
							<c:when test="${list.privacy_setting == 1}">
								<input type="radio" id="private" class="mdl-radio__button" name="privacy_setting" value="1" checked>						
							</c:when>
							<c:otherwise>
								<input type="radio" id="private" class="mdl-radio__button" name="privacy_setting" value="1">
							</c:otherwise>
						</c:choose>
					...
					<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="friends">
						<c:choose>
							<c:when test="${list.privacy_setting == 2}">
								<input type="radio" id="friends" class="mdl-radio__button" name="privacy_setting" value="2" checked>						
							</c:when>
							<c:otherwise>
								<input type="radio" id="friends" class="mdl-radio__button" name="privacy_setting" value="2">
							</c:otherwise>
						</c:choose>
